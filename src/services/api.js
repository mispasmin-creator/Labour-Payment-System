...
export function filterValidEntries(list) {
  ...
  return list.filter(isValidEntry).map((e, idx) => {
    ...
    return {
      ...
      labourCount,
      totalAmount,
      verificationPlanned: cleanTimestamp(e.verificationPlanned),
      approvalPlanned: cleanTimestamp(e.approvalPlanned),
      paymentPlanned: cleanTimestamp(e.paymentPlanned),
      tallyPlanned: cleanTimestamp(e.tallyPlanned),
